...
int main ( int argc, char *argv[] )
{
    ...
    int input1;
    int input2;
    int output1; int output2; int p; double wtime; /*
    ...
    */
    ...
    if ( id == 0 ) {
        ...
        wtime = MPI_Wtime ( );
        p0_set_input ( &input1, &input2 ); p0_send_input ( input1, input2 ); p0_receive_output ( &output1, &output2 );
    ...
    */
        ...
        output1 = p1_compute_output ( input1 ); p1_send_output ( output1 );
        wtime = MPI_Wtime ( ) - wtime;
